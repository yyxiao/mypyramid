...
class Wechat:
    ...
    def access_token():
        ...
        :return:
        """
        url_response = urllib.request.urlopen(WX_TOKEN % (AppID, AppSecret))
    ...
    def authorize():
        ...
        :return:
        """
        url_response = urllib.request.urlopen(WX_AUTHORIZE % (AppID, 'https://www.baidu.com','snsapi_base', 's'))
        return url_response.read()
