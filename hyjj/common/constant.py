...
SMS_DESC = '您的账号绑定验证码为%s，请在三分钟内输入该有效验证码'
...
RISK_SECOND = '02'
RISK_THIRD = '03'
RISK_MSG = {'01': '保守型:您的投资目标是寻求资本的保值，其次为资本的缓和升值，可承受的风险较低。',
            '02': '稳健性:您的投资目标是资本缓和升值，其次为资本保值，可承担中等风险。',
            '03': '积极型:您的投资目标是增值财富，您可承受一定风险，并了解高收益总是与高风险相伴。'}
RISK_TYPE_LEVEL = {'01': '低风险',
                   '02': '中风险,低风险',
                   '03': '高风险,中风险,低风险'}
